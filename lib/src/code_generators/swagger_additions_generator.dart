...
class SwaggerAdditionsGenerator {
  ...
  String generateIndexes(
    ...
    final importsList = buildExtensions.keys.map((String key) {
      ...
      return 'export \'$fileName.dart\' show ${getClassNameFromFileName(fileName)}SwaggerExtension, ${className.camelCase}Services;';
    }).toList();

    importsList.sort();

    var str = importsList.join('\n');
    if (hasConverter) {
...
class JsonSerializableConverter extends chopper.JsonConverter {
  ...
  String generateCustomJsonDecoder(String fileName, bool hasModels) {
    if (!hasModels) {
      return '';
    }
